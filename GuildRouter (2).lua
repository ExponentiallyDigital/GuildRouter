...
--    UpdateAddOnMemoryUsage() print(string.format("Memory usage: %.1f KB", GetAddOnMemoryUsage("GuildRouter")))
    collectgarbage("collect") UpdateAddOnMemoryUsage() print(string.format("Memory usage: %.1f KB", GetAddOnMemoryUsage("GuildRouter")))
end
